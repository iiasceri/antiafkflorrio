rm -rf build;rm -rf dist;rm -rf florrioafkmac.spec
brew install create-dmg
/opt/homebrew/opt/python@3.9/bin/python3.9 -m PyInstaller --name 'afkinflorrio' --icon 'icon.icns' --windowed florrioafkmac.py
create-dmg \
